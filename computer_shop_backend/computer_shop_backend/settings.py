"""
Django settings for computer_shop_backend project.
...
# ALLOWED_HOSTS = []
# ALLOWED_HOSTS = ['192.168.8.197', 'localhost', '127.0.0.1']
ALLOWED_HOSTS = ['*']
...
WSGI_APPLICATION = 'computer_shop_backend.wsgi.application'
