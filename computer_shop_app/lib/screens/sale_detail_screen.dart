...
//   late SaleStatus _selectedStatus;
//   final ApiService _apiService = ApiService();

//   @override
//   void initState() {
//     super.initState();
//     _modelController = TextEditingController(text: widget.sale.model);
//     _specsController = TextEditingController(text: widget.sale.specs);
...
//     try {
//       final updatedSale = ComputerSale(
//         id: widget.sale.id,
...
//       await _apiService.updateComputerSale(updatedSale);
...
//     try {
//       await _apiService.deleteComputerSale(widget.sale.id!.toString());
...
//     return Scaffold(
//       appBar: AppBar(title: Text("Edit ${widget.sale.model}")),
//       body: Padding(
